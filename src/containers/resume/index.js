...
export class ResumePage extends PureComponent {
  constructor(props) {
    super(props)
        ...
        description: (
          <div>
            <p>
              ...
              <a href="https://github.com/leidenglai/ManagementSystem-React" target="_blank" rel="noopener noreferrer">
      ...
      },
      {
        ...
        description: (
          <div>
            <p>
              项目地址为开源的架构demo;
              <a href="https://github.com/leidenglai/frontend-webpack" target="_blank" rel="noopener noreferrer">
                frontend-webpack github
              </a>
            </p>
            <p />
            <p />
            ...
            <p>
              此系统所有的代码规范、开发环境、底层架构、公共插件和组件都是由我搭建和编写，之后再在项目组里面培训的开发流程，进行接下来的业务模块和组件化开发。
            </p>
            <p>项目优势：&nbsp;</p>
            <p>• 轻量级：使用zepto+director.js+es6的组合。实现组件化开发，模块解耦</p>
            <p>
              •
              易上手：因为是个快速项目，尽量没有使用react等现阶段很火的前端架构，而是自己搭建了一个相对篇传统的底层结构，使同事在合作中能快速上手，介入开发。
            </p>
